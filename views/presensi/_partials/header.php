...
if($this->uri->segment(1)== "mahasiswa"){
  $this->load->view('presensi/_partials/layout');
  $this->load->view('presensi/_partials/sidebar');
} elseif($this->uri->segment(1)== "dosen") {
  $this->load->view('presensi/_partials/layout');
  $this->load->view('presensi/_partials/sidebar_dosen');
} elseif($this->uri->segment(1)== "adminpanel"){
  $this->load->view('presensi/_partials/layout');
  $this->load->view('presensi/_partials/sidebar_admin');
}
?>
